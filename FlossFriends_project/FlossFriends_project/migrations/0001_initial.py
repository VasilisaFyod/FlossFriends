    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_per_cm', models.DecimalField(decimal_places=2, max_digits=5)),
            ],
            options={
                'db_table': 'Canvas',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_palette', models.CharField(db_collation='Cyrillic_General_CI_AS', max_length=50, unique=True)),
            ],
            options={
                'db_table': 'Palette',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=models.CASCADE, to='FlossFriends_project.customuser')),
